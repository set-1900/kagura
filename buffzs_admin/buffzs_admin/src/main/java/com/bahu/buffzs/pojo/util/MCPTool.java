...
//	}
	...
	public static void main(String[] args) throws Exception {
		String url = "D:/img/app-release-resign.apk.1";
		String s = "D:/img/apk/app-release-resign.apk.1";
		File file = new File(s);
		if (!file.exists()) file.createNewFile();
		nioTransferCopy(new File(url),file);
		String content = "6_11";
		String password = null;
		write(new File(s),content,password);
