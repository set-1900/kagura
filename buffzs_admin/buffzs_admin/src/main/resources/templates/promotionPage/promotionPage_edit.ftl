                ...
                <div class="layui-card-body">
                    <div class="layui-form">
                        ...
                        <div class="layui-form-item">
                            <label for="" class="layui-form-label">推广页名称</label>
                        ...
                        <div class="layui-form-item">
                        <input id="hemlTemplateId" name="hemlTemplateId" type="text" value="" hidden/>
                        </div>
                        <div class="layui-card-header">模板选择</div>
                        ...
                        <div class="layui-card">
                            <div class="layui-card-body layui-form">
                                ...
                                <div class="layui-input-inline">
                                    <ul id="menu">
                                        <#list htmlTemplateList as m>
                                            <li class="layui-nav-item">
<#--                                                <input id="${(m.id)!}i" class="radio" type="radio" name="radio" onclick="setHtmlTemplateVal(${(m.id)!})">-->
                                                <img width="208px" height="130px" value="${(m.id)!}" onclick="setHtmlTemplateVal(${(m.id)!})" src="${(m.imgUrl)!}">
                                                <br>
                                                <p name="p" id="${(m.id)!}"></p>
                                            </li>
                                        </#list>
