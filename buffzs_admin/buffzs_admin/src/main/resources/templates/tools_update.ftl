            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-form">
                        <input type="text" name="id" value="${(tools.id)!}" hidden/>
                        <div class="layui-form-item">
                            <div class="layui-form-item">
                                <label for="" class="layui-form-label">工具名称</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="title" value="${(tools.title)!}" class="layui-input"/>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="detail" value="${(tools.detail)!}" class="layui-input"/>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="shortDescribe" value="${(tools.shortDescribe)!}" class="layui-input"/>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <div class="layui-upload-list">
                                        <img class="layui-upload-img headImage" src="${(tools.icon)!}" id="demo"
