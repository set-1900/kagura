            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-form">
                        ...
                        <input id="img3" type="text" name="img3" value="" hidden/>
                        <input id="img4" type="text" name="img4" value="" hidden/>
                        <input id="img5" type="text" name="img5" value="" hidden/>
                        <input id="img6" type="text" name="img6" value="" hidden/>
                        <input id="img7" type="text" name="img7" value="" hidden/>
                        <input id="img8" type="text" name="img8" value="" hidden/>
                        <input id="img9" type="text" name="img9" value="" hidden/>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img headImage" src="http://t.cn/RCzsdCq" id="demo7"
                                         width="200" height="100">
                                    <p id="demoText7"></p>
                                </div>
                            </div>
                            ...
                            <div class="layui-input-inline">
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img headImage" src="http://t.cn/RCzsdCq" id="demo8"
                                         width="200" height="100">
                                    <p id="demoText8"></p>
                                </div>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img headImage" src="http://t.cn/RCzsdCq" id="demo9"
                                         width="200" height="100">
                                    <p id="demoText9"></p>
                                </div>
                            </div>
