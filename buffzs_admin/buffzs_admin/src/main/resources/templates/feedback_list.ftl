        ...
        <div class="layui-col-md12">
            ...
            <div class="layui-card">
                <div class="layui-card-body layui-form">
                    ...
                    <div class="layui-col-md12">
                        <form class="layui-form" id="dataForm" action="/feedback/list" method="post">
                            <input type="text" id="pageCurr" name="current" value="${(feedback.current)!}" hidden/>
                    ...
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td><a class="layui-btn layui-btn-sm" lay-href="/feedback/update?id=${(d.id)!}"
                                   lay-id="${(d.id)!}">修改</a>
                                <a href="javascript:;" onclick="doDel('/feedback/del?id=${(d.id)!}','删除')"
                    ...
                    <@pager count="${(feedback.total)!}" limit="${(feedback.size)!}" curr="${(feedback.current)!}" create="/feedback/edit" />
                </div>
            </div>
        </div>
    </div>
